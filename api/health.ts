...
export default async function handler(req: any, res: any) {
  ...
  const siteId = process.env.SITE_ID || 'soy_prod_001'
  const siteName = process.env.SITE_NAME || 'soymetaforica.com'
  ...
  // CMS check - fetch 1 podcast episode with 2000ms timeout
